...
while currentIndex < (len(liste)-1):
    ...
    if flag == 1:
        ...
        """pop the item of the current index with using flag"""
        currentIndex = -1                   
        """if any item deleted, current index has to be zero. current index is -1 because it will increase next line. """ 
        flag = 0
    currentIndex = currentIndex + 1         
    """increase the current item for next step"""
print(liste)
